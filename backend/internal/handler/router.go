...
func NewRouter(d Deps) http.Handler {
	...
	exhibitions := NewExhibitionHandler(d.Services.Exhibitions, d.Services.Audit)
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Get("/exhibitions", exhibitions.List)
		r.Get("/series", exhibitions.List)
		...
		r.Group(func(r chi.Router) {
			...
			r.Patch("/admin/artworks/reorder", artworks.ReorderArtworks)
			...
			r.Patch("/admin/categories/reorder", categories.Reorder)
			r.Post("/admin/exhibitions", exhibitions.Create)
			r.Put("/admin/exhibitions/{id}", exhibitions.Update)
			r.Delete("/admin/exhibitions/{id}", exhibitions.Delete)
			r.Patch("/admin/exhibitions/reorder", exhibitions.Reorder)
			r.Post("/admin/series", exhibitions.Create)
			r.Put("/admin/series/{id}", exhibitions.Update)
			r.Delete("/admin/series/{id}", exhibitions.Delete)
			r.Patch("/admin/series/reorder", exhibitions.Reorder)
